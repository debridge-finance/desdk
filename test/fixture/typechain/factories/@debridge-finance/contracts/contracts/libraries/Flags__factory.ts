...
export class Flags__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): Flags__factory {
    return super.connect(runner) as Flags__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FlagsInterface {
    return new Interface(_abi) as FlagsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Flags {
    return new Contract(address, _abi, runner) as unknown as Flags;
  }
}
