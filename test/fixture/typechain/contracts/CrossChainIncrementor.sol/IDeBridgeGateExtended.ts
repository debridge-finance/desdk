...
export interface IDeBridgeGateExtendedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "claim"
      | "flash"
...
export interface IDeBridgeGateExtended extends BaseContract {
  connect(runner?: ContractRunner | null): IDeBridgeGateExtended;
  ...
  globalFixedNativeFee: TypedContractMethod<[], [bigint], "nonpayable">;
