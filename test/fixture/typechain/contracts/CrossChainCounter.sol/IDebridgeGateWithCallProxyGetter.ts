...
export interface IDebridgeGateWithCallProxyGetterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "callProxy"
      | "claim"
...
export interface IDebridgeGateWithCallProxyGetter extends BaseContract {
  connect(runner?: ContractRunner | null): IDebridgeGateWithCallProxyGetter;
  waitForDeployment(): Promise<this>;

  interface: IDebridgeGateWithCallProxyGetterInterface;
  ...
  callProxy: TypedContractMethod<[], [string], "nonpayable">;
